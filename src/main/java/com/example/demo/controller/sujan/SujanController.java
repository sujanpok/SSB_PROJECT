...
public class SujanController {
	...
	public String personalInfo1(@ModelAttribute SujanForm1 sujanForm1, @ModelAttribute SujanDto SujanDto, Model model) {
	...
	public String personalInfo2Back(@ModelAttribute SujanForm1 sujanForm1, @ModelAttribute SujanDto SujanDto,
			Model model) {
		model.addAttribute("genderItem", SujanForm1.getGenderItem());
		model.addAttribute("merriageStsList", SujanForm1.getMerriageItems());
		model.addAttribute("dateOfYearList", SujanForm1.getYearItems());
	...
	public String personalInfo2(@ModelAttribute SujanForm2 sujanForm2, @ModelAttribute SujanForm1 sujanForm1,
	...
	public String personalInfo3Back(@ModelAttribute SujanForm2 sujanForm2, @ModelAttribute SujanDto SujanDto,
			Model model) {
	...
	public String personalInfo3(@ModelAttribute SujanForm3 sujanForm3, @ModelAttribute SujanForm2 sujanForm2,
			@ModelAttribute SujanDto SujanDto, Model model) {
	...
	public String personalInfo4Back(@ModelAttribute SujanForm3 sujanForm3, @ModelAttribute SujanDto SujanDto,
			Model model) {
		model.addAttribute("livingSituationList", SujanForm3.getLivingSituationList());
		model.addAttribute("housingLoanButton", SujanForm3.getHousingLoanButton());
		model.addAttribute("drivingLicenseLabelButton", SujanForm3.getDrivingLicenseLabelButton());
	...
	public String personalInfo4(@ModelAttribute SujanForm4 sujanForm4, @ModelAttribute SujanForm3 sujanForm3,
			@ModelAttribute SujanDto SujanDto, Model model) {
		ModelMapper modelMapper = new ModelMapper();
	...
	public String personalInfo5(@ModelAttribute SujanDto sujanDto, @ModelAttribute SujanForm4 sujanForm4, Model model) {
		ModelMapper modelMapper = new ModelMapper();
	...
	public String DbInsertback(@ModelAttribute SujanForm4 sujanForm4, @ModelAttribute SujanDto SujanDto, Model model) {
		return "sujan/personalInfoForm4";
	}
